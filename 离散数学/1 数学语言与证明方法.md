...
- {: id="20210111220435-ghfgq7a"}**不交**
  - {: id="20210111220441-ijnbv94"}定义：两个集合没有相同元素，称为 **不交**
  - {: id="20210111220450-wgbitkz"}记作： $\footnotesize A \cap B=\varnothing$
  - {: id="20210111220459-bpk24ih"}推论： $\varnothing$ 与任何集合都是不交的
  {: id="20210110182820-d4czeyz"}
...
- {: id="20210110230458-28igym8"}
{: id="20210110204720-bq296y4"}

{: id="20210110225636-0idp26p"}
