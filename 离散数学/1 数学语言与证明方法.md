...
- {: id="20210113235158-5l3s8is"}运算符号
  - {: id="20210113235211-ptnth78"}$\footnotesize a\mid b$ ：a 整除 b ，例如 $\footnotesize 3\mid 9$
...
- {: id="20210113235227-zfnehfd"}逻辑符号
  ...
  - {: id="20210113235534-qni5gfj"}$\footnotesize \forall$ ：全称量词
  - {: id="20210113235543-ew197bz"}$\footnotesize \exist$ ：存在量词
