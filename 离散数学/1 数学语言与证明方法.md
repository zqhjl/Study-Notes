...
- {: id="20210112213110-xrjzbsa"}证明方法
  ...
  - {: id="20210112220041-8n2lphd"}**数学归纳法**
    - {: id="20210112223912-k94uva0"}数学归纳法
      - {: id="20210112220055-euiio2t"}设命题 $\footnotesize P(n),n\in N,n\geq n_0$ ，**若**
        - {: id="20210112223423-jetuul3"}$\footnotesize P(n_0)$ 为真
        - {: id="20210112223506-vctx7qy"}$\footnotesize \forall\  n(n\in N,n\geq n_0)$ ，假设 $\footnotesize P(n)$ 为真，则 $\footnotesize P(n+1)$ 为真
        {: id="20210112223816-xjzhk1r"}
      - {: id="20210112223932-4nmokwy"}**则** 该命题成立
      {: id="20210112220056-850xyha"}
    - {: id="20210112224015-t4i3uve"}第二数学归纳法
      - {: id="20210113191756-xvjatxn"}设命题 $\footnotesize P(n),n\in N,n\geq n_0$ ，**若**- $\footnotesize P(n_0)$ 为真
        {: id="20210113191758-u1p7h1y"}

        - {: id="20210113191758-rh74qgh"}$\footnotesize \forall\  n(n\in N,n\geq n_0)$ ，假设 $\footnotesize P(n)$ 为真，则 $\footnotesize P(n+1)$ 为真
        {: id="20210113191758-bzwvzk1"}
      {: id="20210113191758-ooq2d6y"}
