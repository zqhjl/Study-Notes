...
- {: id="20210110173649-ogppxiz"}逻辑符号
  - {: id="20210111225639-8eop3ji"}$\footnotesize \neg p$ ：否定联结词，为真当且仅当 p 为假
  - {: id="20210111225826-h5jzn34"}$\footnotesize p\wedge q$ ：合取联结词，为真当且仅当 p 与 q 同时为真
  - {: id="20210111225949-z4f7o8o"}$\footnotesize p\vee q$ ：析取联结词，为假当且仅当 p 与 q 同时为假
  - {: id="20210111230051-7askuzm"}$\footnotesize p\rightarrow q$ ：蕴涵联结词，为假当且仅当 p 为真而 q 为假
  - {: id="20210111230439-104wxpx"}$\footnotesize p\leftrightarrow q$ ：等价联结词，为真当且仅当p 与 q 同时为真
