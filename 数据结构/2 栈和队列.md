...
- {: id="20210130205116-8p883gr"}定义
  ...
  - {: id="20210202234113-srkmfof"}一个函数、过程或数据结构定义的内部又直接（或间接）出现定义本身的应用
...
- {: id="20210213230511-d9qropd"}分治法
  ...
  - {: id="20210213230521-u5bbdii"}定义
    ...
    - {: id="20210219195501-y5x4jda"}**即**分解-求解策略
      {: id="20210219195501-tnht68d"}
    {: id="20210219195434-kvfgepu"}
  {: id="20210213230521-kzm2b1s"}
{: id="20210130205114-lvui9qy"}

<iframe width="560" height="315" src="https://www.youtube.com/embed/ukZJ7EnxKLU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

{: id="20210219235544-azy58wa"}

{: id="20210219235544-ypczu5p"}

{: id="20210219234109-k7uampv"}

{: id="20210219233636-d907g5o"}

{: id="20210219233526-e2km8n6"}

{: id="20210219233224-js8qc6w"}

{: id="20210219233024-j213dvz"}
