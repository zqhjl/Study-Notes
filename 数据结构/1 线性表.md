...
- {: id="20210126171031-7h8x933"}时间复杂度
  - {: id="20210126171244-ne2o799"}顺序存储结构： $O(m\times n)$
  - {: id="20210126171310-2xmor8u"}链式存储结构： $O(m\times n)$
...
- {: id="20210126171223-0nv9c5j"}有序表
{: id="20210126171221-g2mgx0o"}

{: id="20210126180543-cvfmbaq"}
