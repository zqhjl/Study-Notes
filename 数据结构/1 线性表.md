...
- {: id="20210123221011-oa6z04h"}特殊概念
  - {: id="20210123221100-w356wk4"}首元结点：((20210122170513-jdlg2cq "链表")) 中存储第一个 ((20210118115037-6h08c9j "数据元素")) 的 ((20210122170313-wsturbw "结点"))
  - {: id="20210123221224-olo25c6"}头结点
    - {: id="20210123221249-1g1gpli"}定义：((20210122170507-2f0rmf4 "指针域")) 指向 ((20210123221100-w356wk4 "首元结点")) 的 ((20210122170313-wsturbw "结点"))
    - {: id="20210123221422-vardyvd"}作用
      - {: id="20210123221426-lcvw8zn"}使得对 ((20210123221100-w356wk4 "首元结点")) 的处理与其后的 ((20210122170313-wsturbw "结点")) 处理方式相同
      {: id="20210123221426-thypshc"}
    {: id="20210123221249-ifd4fsp"}
  {: id="20210123221101-vfnxit9"}
...
- {: id="20210123220618-p5natq5"}定义：最后一个 ((20210122170313-wsturbw "结点")) 的 ((20210122170507-2f0rmf4 "指针域")) 指向头结点的 ((20210122165817-v6jc9n3 "单链表"))
