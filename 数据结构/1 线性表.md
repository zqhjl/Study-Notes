...
### 有序表（Ordered List）
{: id="20210126223100-4wz6lin"}

- {: id="20210126223152-7oeqhw5"}((20210118164505-dl01jw9 "线性表")) 中的 ((20210118115037-6h08c9j "数据元素")) 相互之间可以比较
  {: id="20210201004639-x5peuaj"}
- {: id="20210126223154-zwvhs20"}((20210118115037-6h08c9j "数据元素")) 在 ((20210118164505-dl01jw9 "线性表")) 中依值非递减或非递增有序排列
  {: id="20210201004639-fey0qxa"}
{: id="20210126223152-346tqqz"}
...
- {: id="20210124212232-5fetvde"}存储密度的大小
  ...
  - {: id="20210124220955-q9wb7c9"}((20210118212213-jp1enaw "顺序表")) 的 ((20210124212254-d7ow63k "存储密度")) 为1
    {: id="20210201004639-qo6p29b"}
  - {: id="20210124221129-p344rrw"}((20210122160959-vsxwjkq "链表")) 的 ((20210124212254-d7ow63k "存储密度")) 小于1
...
- {: id="20210126171031-7h8x933"}((20210118110555-49xon8e "时间复杂度"))
  ...
  - {: id="20210126171244-ne2o799"}((20210118104804-olw0skv "顺序存储结构"))： $O(m\times n)$ 
    {: id="20210201004639-1nm2uzd"}
  - {: id="20210126171310-2xmor8u"}((20210118104812-quujvq4 "链式存储结构"))： $O(m\times n)$ 
...
- {: id="20210126171223-0nv9c5j"}顺序 ((20210126223100-4wz6lin "有序表")) 的合并
  ...
  - {: id="20210127101357-1a6rx2f"}算法描述
    ...
    ```
    {: id="20210127101600-4t6ura1"}
  - {: id="20210127101405-778e2uj"}((20210118110555-49xon8e "时间复杂度"))： $O(m+n)$ 
    {: id="20210201004639-4lmhjmv"}
  - {: id="20210127101842-68y89s9"}((20210118114411-vsm7bt7 "空间复杂度"))： $O(m+n)$ 
...
- {: id="20210127101900-o2na2cs"}链式 ((20210126223100-4wz6lin "有序表")) 的合并
  ...
  - {: id="20210127102121-nt4141p"}算法描述
    ...
    ```
    {: id="20210127104757-160xpi3"}
  - {: id="20210127102125-lcbj1h5"}((20210118110555-49xon8e "时间复杂度"))： $O(m+n)$ 
    {: id="20210201004639-t10bjea"}
  - {: id="20210127102435-vetin5w"}((20210118114411-vsm7bt7 "空间复杂度"))： $O(1)$ 
