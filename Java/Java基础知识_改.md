...
- {: id="20210303181533-8cyedu8"}#### Java 和 C++的区别
  ...
  - {: id="20210301203429-ssotvbl"}相同点
    ...
    - {: id="20210303183701-qe8w98d"}都是面向对象的语言，都支持封装、继承和多态
...
- {: id="20210303190645-4an49a4"}#### import java 和 javax 的区别
...
- {: id="20210303191057-cxiaoap"}#### Java 语言“编译与解释并存”
  {: id="20210303191304-k4p9l7e" updated="20210303191753"}


  - {: id="20210303191605-g4umitv"}高级编程语言分类（按照程序的执行方式）
...
{: id="20210301220753-apem785" fold="0" updated="20210303191833"}

### Java 语法
{: id="20210301203429-6eemplz"}

- {: id="20210303193009-4sv17t8"}#### 字符型常量和字符串常量的区别
  {: id="20210303193009-5monbrd" updated="20210303193102"}

  - {: id="20210303193037-4swg3sr"}形式上:
    {: id="20210303193037-vkxctej" updated="20210303193220"}

    - {: id="20210303193221-ga9samk"}字符常量是单引号引起的一个字符;
      {: id="20210303193221-yijhhqv" updated="20210303193225"}
    - {: id="20210303193226-zk8qc8p"}字符串常量是双引号引起的 0 个或若干个字符
      {: id="20210303193226-m3r4afw" updated="20210303193226"}
    {: id="20210303193221-m61unwx"}
  - {: id="20210303193041-zqamylu"}含义上:
    {: id="20210303193041-zb9kelu" updated="20210303193230"}

    - {: id="20210303193230-wtpzxo7"}字符常量相当于一个整型值( ASCII 值),可以参加表达式运算;
      {: id="20210303193230-fcdn1e3" updated="20210303193239"}
    - {: id="20210303193239-m4qfxdb"}字符串常量代表一个地址值(该字符串在内存中存放位置)
      {: id="20210303193239-9hf36hn" updated="20210303193239"}
    {: id="20210303193231-11jjldb"}
  - {: id="20210303193048-zhretya"}占内存大小
    {: id="20210303193048-e8wwm0r" updated="20210303193256"}

    - {: id="20210303193256-jo3uabu"}字符常量只占 2个字节;
      {: id="20210303193256-v3uagb3" updated="20210303193303"}
    - {: id="20210303193303-v8esa43"}字符串常量占若干个字节
      {: id="20210303193303-v58zuku" updated="20210303193307"}
    - {: id="20210303193307-lje7qsa"}**注意： char 在 Java 中占两个字节**
      {: id="20210303193307-cobxuy6" updated="20210303193425"}

      - {: id="20210303193426-78vxppa"}字符封装类`Character`有一个成员常量`Character.SIZE`值为 1,单位是`bits`,该值除以 8(`1byte=8bits`)后就可以得到 2个字节
        {: id="20210303193426-meb7ba8" updated="20210303193426"}
      {: id="20210303193524-yd70hs0"}
    {: id="20210303193257-6wse2nb"}
  {: id="20210303193038-14susxf"}
{: id="20210301203429-hwu26bf" updated="20210303193009"}
