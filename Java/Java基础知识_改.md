...
- {: id="20210302001049-1921lzx"}#### JVM JDK 和 JRE
  {: id="20210301203429-ckz6j5m" updated="20210302183741"}
  ...
  - {: id="20210302001112-tiz67qc"}##### JVM
    ...
    - {: id="20210302001112-6pfdzik" updated="20210302184717"}定义
      ...
      - {: id="20210302184730-pcb52zk"}Java 虚拟机运行 Java((20210301222017-p260tyq "字节码"))的虚拟机
        {: id="20210302184730-oi6y5ep" updated="20210302184730"}
      {: id="20210302184740-1brhvlg"}
    - {: id="20210301231624-vhr9oa2"}JVM 有针对不同系统的特定实现
      ...
      - {: id="20210301221557-mbybzl6"}目的是使用相同的((20210301222017-p260tyq "字节码"))，它们都会给出相同的结果
        {: id="20210301221557-2t4u7b6" updated="20210301221941"}
      {: id="20210302183813-9z49jp4"}
    - {: id="20210301222017-p260tyq"}**字节码**
      ...
      - {: id="20210302000534-ixghue8" updated="20210302000602"}定义
        ...
        - {: id="20210302183835-z57xrux"}在 Java 中，JVM 可以理解的代码就叫做`字节码`
          {: id="20210302183835-mvbkeum" updated="20210302183835"}
      ...
      - {: id="20210302000614-obq67e0" updated="20210302000632"}特点
        ...
        - {: id="20210302184217-4vy9ht0"}它不面向任何特定的处理器，只面向虚拟机
          {: id="20210302184217-owtyuvu" updated="20210302184702"}
      ...
      - {: id="20210302000632-aolfnzs" updated="20210302000639"}作用
        ...
        - {: id="20210302000642-mbvitz0"}同时又保留了解释型语言可移植的特点
          {: id="20210302000642-8pfmzg5" updated="20210302183935"}
        - {: id="20210302183954-06orqco" updated="20210302183956"}使得Java程序运行高效
          {: id="20210302184019-i5uas40" updated="20210302184132"}
        - {: id="20210302000656-8iy4b6u"}因为((20210302000614-obq67e0 "它不针对一种特定的机器"))
          {: id="20210302000656-tcvm8o8" updated="20210302184443"}

          - {: id="20210302184252-03xuulr"}Java 程序无须重新编译便可在多种不同操作系统的计算机上运行。
            {: id="20210302184252-29wei03" updated="20210302184252"}
          {: id="20210302184253-zzj4hw8"}
    ...
    - {: id="20210302185750-7jk8p22"}**Java 程序从源代码到运行**
      ...
      - {: id="20210302184812-kbs8yt4"}过程
        {: id="20210302185750-3cuothd" updated="20210302185753"}

        - {: id="20210302185424-kh6qash"}`.java`文件（源代码）$\downarrow$`JDK中的javac编译`
          {: id="20210302184812-pa5v6dn" updated="20210302185451"}
        - {: id="20210302185634-q2568h2"}`.class`文件（字节码）$\downarrow$`JVM`
          {: id="20210302185451-ituvcz2" updated="20210302185630"}
        - {: id="20210302185756-9kbdssz"}机器可执行的二进制机器码
          {: id="20210302185634-j0a0nye" updated="20210302185713"}
        {: id="20210302185757-4v2s6np"}
      - {: id="20210302190031-jql6lni"}重点
        {: id="20210302185756-af2d74g" updated="20210302185759"}

        - {: id="20210302190045-drpn2br"}热点代码
          {: id="20210302190031-0luzl5b" updated="20210302190035"}

          - {: id="20210302185445-wfzwv9l"}经常需要被调用的方法和代码块
            {: id="20210302190045-ldrpatf"}
          {: id="20210302190307-zapy0bm"}
        - {: id="20210302190307-ek04c72"}JIT 编译器
          {: id="20210302190307-2nqauqa"}

          - {: id="20210302190316-x9c8i2q"}运行时编译
            {: id="20210302190316-41e2ods"}
          - {: id="20210302190326-5tvl6g2"}当 JIT 编译器完成第一次编译后，其会将字节码对应的机器码保存下来，下次可以直接使用
            {: id="20210302190326-mkm2tdc"}
          {: id="20210302190317-xbkqnx5"}
        - {: id="20210302190241-x4h21ox"}.class `->`机器码
          {: id="20210301222247-7g0x8bu" updated="20210302190240"}

          - {: id="20210301222247-po4nlkh"}旧方法
            ...
            - {: id="20210301222303-h4io0cq"}这种方式的执行速度会相对比较慢
              {: id="20210301222303-dl17di1" updated="20210302190108"}
            {: id="20210302190337-r09ojpo"}
          - {: id="20210302190524-clt88yn"}新方法
            {: id="20210302190525-9nqz2s9" updated="20210302190528"}

            - {: id="20210302190524-85dc0p8"}使用((20210302190307-ek04c72 "JIT 编译器"))
              {: id="20210302190524-4tmym17" updated="20210302190524"}

              - {: id="20210301231800-us5pkz0"}机器码的运行效率肯定是高于 Java 解释器的
                {: id="20210301231800-ay03rrv" updated="20210302190520"}
        ...
        {: id="20210302184813-zhm6s8c"}
      {: id="20210301222250-issv5f8"}
    {: id="20210302001050-mlrokfp"}
  - {: id="20210302190525-wmqkabs"}
    {: id="20210302190528-la56dxn"}
  {: id="20210301221308-lpwc0o8" updated="20210302184719"}
{: id="20210301203429-abh1ofm" updated="20210302190511"}
