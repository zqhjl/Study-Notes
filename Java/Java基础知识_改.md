...
- {: id="20210301220753-i9s8qrn"}#### Java 语言特点
  {: id="20210301220753-apem785" updated="20210302191313"}
...
- {: id="20210302001049-1921lzx"}#### JVM JDK 和 JRE
  ...
  - {: id="20210302001112-tiz67qc"}##### JVM
    ...
    - {: id="20210302190800-60xiwrq"}特点
      ...
      - {: id="20210301231624-vhr9oa2"}有针对不同系统的特定实现
  ...
  - {: id="20210301222017-p260tyq"}**字节码**
    ...
    - {: id="20210302000534-ixghue8" updated="20210302000602"}定义
      ...
      - {: id="20210302183835-z57xrux"}在 Java 中，((20210302001112-tiz67qc "JVM"))可以理解的代码就叫做`字节码`
        {: id="20210302183835-mvbkeum" updated="20210302190917"}
    ...
    - {: id="20210302000614-obq67e0" updated="20210302000632"}特点
      ...
      - {: id="20210302184217-4vy9ht0"}它不面向任何特定的处理器，只面向((20210302001112-tiz67qc "JVM"))
        {: id="20210302184217-owtyuvu" updated="20210302190927"}
    ...
    - {: id="20210302190031-jql6lni"}重点
      ...
      - {: id="20210302190625-ojyyb56"}热点代码
        ...
        - {: id="20210302190629-33wk82v" updated="20210302190633"}评估方法
          ...
          - {: id="20210302191453-e3u1u08"}会根据代码每次被执行的情况收集信息并相应地做出一些优化
            {: id="20210302191453-j84iq9p" updated="20210302191530"}
          {: id="20210302191344-y0020e3"}
        {: id="20210302190307-zapy0bm"}
      - {: id="20210302191144-59tn1br"}JIT 编译器
        {: id="20210302190307-2nqauqa"}

        - {: id="20210302190307-ek04c72"}特点
          {: id="20210302191144-l9hf6fq" updated="20210302191149"}

          - {: id="20210302190316-x9c8i2q"}运行时编译
            {: id="20210302190316-41e2ods"}
          - {: id="20210302190326-5tvl6g2"}当 JIT 编译器完成第一次编译后，
            {: id="20210302190326-mkm2tdc"}
          - {: id="20210302190606-fehjl49"}其会将((20210302190625-ojyyb56 "热点代码"))对应的机器码保存下来，下次可以直接使用
            {: id="20210302190606-inuwe5j" updated="20210302191122"}
          {: id="20210302191145-kyksac7"}
        ...
        - {: id="20210302190524-clt88yn"}新方法
          ...
          - {: id="20210302190524-85dc0p8"}使用((20210302190307-ek04c72 "JIT 编译器"))
            ...
            - {: id="20210301231803-hqp4u7k"}这也解释了我们为什么经常会说 Java 是编译与解释共存的语言。
              {: id="20210301231803-86djfhf" updated="20210302190534"}
...
{: id="20210301203429-abh1ofm" updated="20210302191453"}
