...
- {: id="20210302001049-1921lzx"}#### JVM JDK 和 JRE
  ...
  - {: id="20210302001112-tiz67qc"}##### JVM
    ...
    - {: id="20210301222017-p260tyq"}字节码
      {: id="20210301221941-iaeoi5n" updated="20210302183822"}
    ...
    - {: id="20210302184812-kbs8yt4"}Java 程序从源代码到运行一般有下面 3 步
      {: id="20210301222008-vtvpvgz" updated="20210302184603"}

      - {: id="20210302185424-kh6qash"}`.java`文件（源代码）$\downarrow$`JDK中的javac编译`
        {: id="20210302184812-pa5v6dn" updated="20210302185451"}
      - {: id="20210302185445-wfzwv9l"}
        {: id="20210302185451-ituvcz2"}

        ![Java程序运行过程](https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/Java%20%E7%A8%8B%E5%BA%8F%E8%BF%90%E8%A1%8C%E8%BF%87%E7%A8%8B.png)
        {: id="20210301222050-8ge79b0" updated="20210301222245"}

        - {: id="20210301222247-po4nlkh"}.class `->`机器码 这一步
          {: id="20210301222247-7g0x8bu" updated="20210302184639"}
  ...
  - {: id="20210302185445-p1ncr0a"}
    {: id="20210302185451-ep8zpr2"}
  {: id="20210301221308-lpwc0o8" updated="20210302184719"}
{: id="20210301203429-abh1ofm" updated="20210302185148"}
