  ...
  - {: id="20210302194722-tj8r8c3"}##### JVM
    ...
    - {: id="20210301222017-p260tyq"}**字节码**
      ...
      - {: id="20210302000534-ixghue8" updated="20210302000602"}定义
        ...
        - {: id="20210302183835-z57xrux"}在 Java 中，((20210302194722-tj8r8c3 "JVM"))可以理解的代码就叫做`字节码`
          {: id="20210302183835-mvbkeum" updated="20210302195755"}
      ...
      - {: id="20210302190031-jql6lni"}重点
        ...
        - {: id="20210302192729-vsp2xyk"}JIT编译器
          ...
          - {: id="20210302192720-0eh3xac"}特点
            ...
            - {: id="20210302190326-5tvl6g2"}当 JIT 编译器完成编译后，会将((20210302190625-ojyyb56 "热点代码"))对应的机器码保存下来，下次可以直接使用
              {: id="20210302190326-mkm2tdc" updated="20210302195842"}
  ...
  - {: id="20210302194904-i48ne1j"}JDK 和 JRE
    ...
    - {: id="20210302195454-efjfu07"}JRE（Java Runtime Enviroment）
      ...
      - {: id="20210302195518-mzeemi4"}包括
        ...
        - {: id="20210302195521-73ln97d"}Java虚拟机（JVM）
          {: id="20210302195521-lf8ni8g" updated="20210302195540"}
      ...
      - {: id="20210302195702-zdz0jqs" updated="20210302195702"}特点
        ...
        - {: id="20210302195709-y6hse3k"}不能用于创建新程序
          {: id="20210302195709-oulhxti" updated="20210302204622"}
        {: id="20210302195714-zggn2bo"}
