    ...
    - {: id="20210302190031-jql6lni"}重点
      ...
      - {: id="20210302190241-x4h21ox"}.class `->`机器码
        ...
        - {: id="20210302192424-43d0m9h"}新方法
          ...
          - {: id="20210302190524-clt88yn"}过程
            ...
            - {: id="20210302190524-85dc0p8"}使用((20210302192729-vsp2xyk "JIT编译器"))
              {: id="20210302190524-4tmym17" updated="20210302192909"}
      ...
      - {: id="20210302192729-vsp2xyk"}JIT编译器
        ...
        - {: id="20210302192720-0eh3xac"}特点
          ...
          - {: id="20210302190326-5tvl6g2"}当 JIT 编译器完成第一次编译后，其会将((20210302190625-ojyyb56 "热点代码"))对应的机器码保存下来，下次可以直接使用
            {: id="20210302190326-mkm2tdc" updated="20210302192943"}
      ...
      - {: id="20210302193113-4x815se"}AOT(Ahead of Time Compilation)
        ...
        - {: id="20210302193214-vr8crp0"}特点
          ...
          - {: id="20210302193220-bplpwh8"}编译质量是肯定比不上 JIT 编译器
            {: id="20210302193220-jbxb1ef"}
          {: id="20210302193220-9yyrgjy"}
...
{: id="20210301203429-abh1ofm" updated="20210302193228"}
