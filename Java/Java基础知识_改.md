...
- {: id="20210303191057-cxiaoap"}#### Java 语言“编译与解释并存”
  ...
  - {: id="20210303191830-768l5hy"}Java 语言既具有编译型语言的特征，也具有解释型语言的特征，因为
    ...
    - {: id="20210303191852-awkjhk2"} Java 程序要经过先编译，后解释两个步骤，由 Java 编写的程序需要先经过编译步骤，生成字节码（\*.class 文件），这种字节码必须由 Java 解释器来解释执行。因此，我们可以认为 Java 语言编译与解释并存。
      {: id="20210303191852-zxthgs8" updated="20210303191852"}
