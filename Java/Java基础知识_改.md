      ...
      - {: id="20210302190241-x4h21ox"}.class `->`机器码
        ...
        - {: id="20210302192424-43d0m9h"}新方法
          ...
          - {: id="20210302190524-clt88yn"}过程
            ...
            - {: id="20210302190524-85dc0p8"}使用【【JIT编译器
              {: id="20210302190524-4tmym17" updated="20210302192526"}
          ...
          - {: id="20210301231800-ay03rrv" updated="20210302190520"}原因
            ...
            - {: id="20210301231803-hqp4u7k"}因此 Java 是编译与解释共存的语言。
              {: id="20210301231803-86djfhf" updated="20210302191836"}
      ...
      - {: id="20210302190625-ojyyb56"}热点代码
        ...
        - {: id="20210302190629-33wk82v" updated="20210302190633"}评估方法
          ...
          - {: id="20210302191335-kk5jm9u"}惰性评估(Lazy Evaluation)
            ...
            - {: id="20210302191600-twijy5q"}根据二八定律，消耗大部分系统资源的只有那一小部分的代码
              {: id="20210302191600-ocv0691"}
            {: id="20210302191601-umj4250"}
          - {: id="20210302191453-e3u1u08"}((20210302001049-hpmqlu6 "JVM")) 会根据代码每次被执行的情况收集信息并相应地做出一些优化
            {: id="20210302191453-j84iq9p" updated="20210302191548"}
          {: id="20210302191344-y0020e3"}
        {: id="20210302190307-zapy0bm"}
      - {: id="20210302191144-59tn1br"}JIT编译器
        {: id="20210302190307-2nqauqa" updated="20210302192516"}
...
{: id="20210301203429-abh1ofm" updated="20210302191610"}
