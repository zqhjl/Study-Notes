...
- {: id="20210306094726-e6hcy5x" fold="1"}#### `==`和 `equals` 的区别
...
- {: id="20210306231052-ko7muy7"}#### `hashCode()`与`equals()`
  {: id="20210306231052-r7bi563" updated="20210306231957"}


  - {: id="20210306231121-2qafh79"}> 为什么重写 `equals` 时必须重写 `hashCode` 方法？
    > {: id="20210306232040-fl9a3qv"}
    >
    {: id="20210301203429-tsqsfsd" updated="20210306232040"}
  - {: id="20210306232030-7cmb3nt"}`hashCode()`介绍
    {: id="20210306232030-isea983" updated="20210306232045"}

    - {: id="20210306232109-a5ji5z1"}作用
      {: id="20210306232109-zbd3lnz" updated="20210306232113"}

      - {: id="20210306232113-hc8ayia"}获取哈希码，也称为散列码
        {: id="20210306232113-saq7l4j" updated="20210306232117"}
      - {: id="20210306232117-wjt194i"}它实际上是返回一个 int 整数
        {: id="20210306232117-9vli73m" updated="20210306232122"}
      {: id="20210306232127-058d7d3"}
    - {: id="20210306232123-z4sv3ln"}哈希码
      {: id="20210306232123-ze6c6m3" updated="20210306232135"}
    ...
    - {: id="20210306232143-nhy0qfb"}`hashCode()`定义在 JDK 的 `Object` 类中
      {: id="20210306232143-qssjpe7" updated="20210306232218"}
    - {: id="20210306232218-c599aq4"}这就意味着 Java 中的任何类都包含有 `hashCode()` 函数
      {: id="20210306232218-jl0maue" updated="20210306232243"}
    - {: id="20210306232243-gaaqg61"}另外需要注意的是
      {: id="20210306232243-xt6f35t" updated="20210306232246"}
...
{: id="20210306000253-l6geewy" updated="20210306232055"}
