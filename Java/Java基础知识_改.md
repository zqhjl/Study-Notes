  ...
  - {: id="20210302194722-tj8r8c3"}##### JVM
    ...
    - {: id="20210302185750-7jk8p22"}**Java 程序从源代码到运行**
      ...
      - {: id="20210302190031-jql6lni"}重点
        ...
        - {: id="20210302193824-qvv7hd4"}((20210302195245-jbqu5im "JDK"))支持分层编译和AOT协作使用
          {: id="20210302193824-j29n8ow" updated="20210303180528"}
...
{: id="20210301220753-apem785" fold="0" updated="20210303180333"}
