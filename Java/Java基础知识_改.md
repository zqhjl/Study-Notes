...
- {: id="20210303193307-lje7qsa"}**注意： char 在 Java 中占两个字节**
  ...
  {: id="20210305133243-591p6eq"}

  * {: id="20210305133201-3y93j2o"}关于注释？
    {: id="20210301203429-wqhl5zj" updated="20210305133209"}

    * {: id="20210305133209-twffv52"}Java 中的注释有三种：
      {: id="20210305133209-nt9lte7" updated="20210305133209"}
