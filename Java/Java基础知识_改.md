...
- {: id="20210306231052-ko7muy7"}#### `hashCode()`与`equals()`
  ...
  - {: id="20210306231121-2qafh79"}**为什么重写 `equals` 时必须重写 `hashCode` 方法？**
    {: id="20210306232040-fl9a3qv" updated="20210306233831"}
  - {: id="20210306232030-7cmb3nt"}`hashCode()`介绍
    ...
    - {: id="20210307160433-yqgyeoe"}为什么要有 hashCode？**
      {: id="20210307160433-6xmoam0"}
    {: id="20210301203429-7fq82ro" updated="20210307160432"}
  {: id="20210306231135-mtxrk5x"}
{: id="20210306000253-l6geewy" updated="20210306233936"}
