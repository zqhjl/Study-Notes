...
- {: id="20210306094726-e6hcy5x"}#### `==`和 `equals` 的区别
  ...
  - {: id="20210306103739-ed5xdbg"}`equals()`
    ...
    - {: id="20210306103747-1ywwnwp"}作用
      ...
      - {: id="20210306103810-srqum7z"}它不能用于比较基本数据类型的变量。`equals()`方法存在于`Object`类中，而`Object`类是所有类的直接或间接父类。
        {: id="20210306103810-du1h9w9" updated="20210306103809"}
      {: id="20210306103802-6fz8qtl"}
