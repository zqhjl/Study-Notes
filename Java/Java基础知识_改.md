# 
{: id="20210301203429-x3j8u0o" updated="20210306130921"}

## Java 基本功
{: id="20210306130004-qofbn7r" updated="20210306130008"}

123
{: id="20210306125625-d44z2qf" updated="20210306125628"}

### Java 入门（基础概念与常识）
{: id="20210301203429-ux8lda5" updated="20210302194531"}

123
{: id="20210306125632-u5qa8g2" updated="20210306125633"}
  ...
  - {: id="20210306103739-ed5xdbg"}`equals()`
    ...
    - {: id="20210306112025-gc6it6y"}使用情况
      ...
      - {: id="20210301203429-22nks3y"}类覆盖了 `equals()`方法
        ...
        - {: id="20210306112906-q1xxwkd"}一般，我们都覆盖 `equals()`方法来两个对象的内容相等；若它们的内容相等，则返回 true(即，认为这两个对象相等)。
          {: id="20210306112906-sng26f0" updated="20210306112906"}
