...
#### Java 语言有哪些特点?
{: id="20210301221807-5ucrcsq" updated="20210305223013" parent-fold="1"}
...
##### JVM
{: id="20210301221807-2wed089" updated="20210305223654" parent-fold="1"}

Java 虚拟机（JVM）是运行 Java 字节码的虚拟机。JVM 有针对不同系统的特定实现（Windows，Linux，macOS），目的是使用相同的字节码，它们都会给出相同的结果。
{: id="20210301221807-k6pashh" updated="20210305223510" parent-fold="1"}
...
{: id="20210301221807-kid92ep" updated="20210305144035" parent-fold="1"}
